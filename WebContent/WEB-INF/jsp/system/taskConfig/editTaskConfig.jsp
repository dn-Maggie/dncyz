				...
				<table class="table">
					<tr>
						...
						<td class="inputTd"><select id="taskType" name="taskType"
							class="select">
								<option value="0"
									<c:if test="${taskConfig.taskType eq 0}" >selected</c:if>>循环</option>
								<option value="1"
									<c:if test="${taskConfig.taskType eq 1}" >selected</c:if>>定时</option>
						</select></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="inputTd"><select id="taskStatus" name="taskStatus"
							class="select">
								<option value="1"
									<c:if test="${taskConfig.taskStatus eq 1}" >selected</c:if>>启用</option>
								<option value="0"
									<c:if test="${taskConfig.taskStatus eq 0}" >selected</c:if>>停用</option>
						</select></td>
