...
var platformAccountModel = {
						url: "<m:url value='/accountOperateIncome/listOperaData.do'/>",
						colModel:[
                        {name : "id",hidden : true,key : true,label:"主键",index : "id"},
           				{name : "storeName",label:"商户名称",index : "store_name"},	
           				{name : "createDate",label:"日期",index : "create_date"},				
           				{name : "createTime",label:"订单时点",index : "create_time"},				
           				{name : "orderNo",label:"订单编号",index : "order_no"},				
           				{name : "orginPrice",label:"原价",index : "orgin_price",calculate:"菜价+餐盒费"},				
           				{name : "discountPrice",label:"菜品折扣",index : "discount_price",calculate:"商户承担活动补贴（菜品折扣部分）"},				
           				{name : "afterDiscountPrice",label:"折扣菜金额",index : "after_discount_price", calculate:"平台折扣菜金额"},				
           				{name : "actualPrice",label:"结算特价",index : "actual_price",calculate:"实际结算特价"},				
           				{name : "orderDistributionCharge",label:"订单上收取客户配送费",index : "order_distribution_charge",calculate:"众包"},				
           				{name : "platformDistributionCharge",label:"平台收取客户配送费",index : "platform_distribution_charge",calculate:"平台配送费"},				
           				{name : "cyzDistributionCharge",label:"公司收取客户配送费",index : "cyz_distribution_charge",calculate:"自配送费用"},				
           				{name : "cyzActivitiesCharge",label:"公司承担线上活动费",index : "cyz_activities_charge",calculate:"商户承担活动补贴（除去菜品折扣部分）"},	
           				{name : "platformActivitiesCharge",label:"平台承担线上活动费",index : "platform_activities_charge",calculate:"平台承担线上活动费"},
           				{name : "platformServiceCharge",label:"平台服务费",index : "platform_service_charge",calculate:"（原价-商户承担活动补贴）*服务费费费率"},		
           				{name : "productSaleAmount",label:"产品销售金额",index : "product_sale_amount",calculate:"原价-菜品折扣"},				
           				{name : "amountReceivable",label:"应收平台结算金额",index : "amount_receivable",calculate:"产品销售金额+公司收取客户配送费-商户承担活动补贴-平台服务费"},				
           				{name : "seventypProductSaleAmount",label:"70%结算金额",index : "seventyP_product_sale_amount",calculate:"（产品销售金额-折扣菜金额（结算特价））*70%"},				
           				{name : "amountPayable",label:"应付店铺结算金额",index : "amount_payable",calculate:"结算比例*结算金额+菜品折扣"},				
           				{name : "cyzServiceCharge",label:"公司收取店铺服务费",index : "cyz_service_charge",calculate:"产品销售金额*（1-结算比例）"},				
           				{name : "distributionActualPayment",label:"自配送实际支付金额",index : "distribution_actual_payment"},
           				{name : "saleGrossProfit",label:"销售毛利",index : "sale_gross_profit",calculate:"产品销售金额-应付店铺结算金额-公司承担线上活动费-平台服务费"},				
           				{name : "saleGrossProfitRate",label:"毛利率",index : "sale_gross_profit_rate",calculate:"毛利/公司收取店铺服务费"},	
           				{name : "remark",label:"备注",index : "remark"},
           				{name : "platformType",label:"平台类型",index : "platform_type",
           					formatter:function(cellvalue, options, rowObject){
           		 				 if (cellvalue=='elm') {return '饿了么';}
