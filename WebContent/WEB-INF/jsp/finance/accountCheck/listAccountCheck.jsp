...
var gridObj = {};
	$(function(){
  		gridObj = new biz.grid({
            ...
            colModel:[
				...
				{name : "accountTime",label:"结算日期",index : "account_time"},				
				{name : "elmSettlement",label:"饿了吗结算款",index : "elm_settlement"},				
				{name : "baiduSettlement",label:"百度结算款",index : "baidu_settlement"},				
				{name : "meituanSettlement",label:"美团结算款",index : "meituan_settlement"},				
				{name : "totalSettlement",label:"合计结算金额",index : "total_settlement"},				
				{name : "elmCost",label:"饿了么扣回金额",index : "elm_cost"},				
				{name : "baiduCost",label:"百度扣回金额",index : "baidu_cost"},				
				{name : "meituanCost",label:"美团扣回金额",index : "meituan_cost"},				
				{name : "actualSettlement",label:"实际应结算金额",index : "actual_settlement"},				
	...
	var show_iframe_dialog;
  	...
  	function add(){
  	//xin zeng iframe 弹出框
		var url="<m:url value='/accountCheck/toAddAccountCheck.do'/>";
    ...
    function edit(){
		...
		var url="<m:url value='/accountCheck/toEditAccountCheck.do'/>?key="+key;
    ...
    function batchDelete(){
    	...
    	if(ids==""){
    		...
    		new biz.alert({type:"confirm",message:I18N.msg_del_confirm,title:I18N.promp,callback:function(result){
    			if(result){
    				$ .ajax({
        				url: "<m:url value='/accountCheck/deleteAccountCheck.do'/>?key="+ids,
        				cache:false,
