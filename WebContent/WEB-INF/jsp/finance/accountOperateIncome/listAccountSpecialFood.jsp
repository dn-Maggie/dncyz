...
var gridObj = {};
	$(function(){
  		gridObj = new biz.grid({
            ...
            url: "<m:url value='/accountSpecialFood/listAccountSpecialFood.do'/>",/*grid初始化请求数据的远程地址*/
	...
	var show_iframe_dialog;
  	...
  	function add(){
  	//xin zeng iframe 弹出框
		var url="<m:url value='/accountSpecialFood/toAddAccountSpecialFood.do'/>";
    ...
    function edit(){
		...
		var url="<m:url value='/accountSpecialFood/toEditAccountSpecialFood.do'/>?key="+key;
    ...
    function show(){
		...
		var url="<m:url value='/accountSpecialFood/toShowAccountSpecialFood.do'/>?key="+key;
    ...
    function batchDelete(){
    	...
    	if(ids==""){
    		...
    		new biz.alert({type:"confirm",message:I18N.msg_del_confirm,title:I18N.promp,callback:function(result){
    			if(result){
    				$ .ajax({
        				url: "<m:url value='/accountSpecialFood/deleteAccountSpecialFood.do'/>?key="+ids,
        				cache:false,
