...
var gridObj = {};
	$(function(){
  		gridObj = new biz.grid({
            ...
            url: "<m:url value='/industry/listIndustry.do'/>",/*grid初始化请求数据的远程地址*/
    ...
    function edit(){
		...
		var url="<m:url value='/industry/toEditIndustry.do'/>?key="+key;
    ...
    function show(){
		...
		var url="<m:url value='/industry/toShowIndustry.do'/>?key="+key;
    ...
    */
    ...
    function batchDelete(){
    	var ids = ICSS.utils.getSelectRowData("industryId");
    	if(ids==""){
    		...
    		new biz.alert({type:"confirm",message:I18N.msg_del_confirm,title:I18N.promp,callback:function(result){
    			if(result){
    				$ .ajax({
        				url: "<m:url value='/industry/deleteIndustry.do'/>?key="+ids,
        				cache:false,
