	...
	$(function(){
  		mrSelectGrid = new biz.grid({
            ...
            colModel:[
    			...
    			{name : "dept",label:"所属部门",width:40},
				{name : "position",label:"所在岗位",width:40},
				{name : "sex",label:"性别",width:20,index:"name"},
				{name : "age",label:"年龄",width:20},
				{name : "idCard",label:"身份证号码",width:80},			
				{name : "mobile",hidden:true},
				{name : "entryDate",hidden:true},
				{name : "educationBackground",hidden:true},
           	],
