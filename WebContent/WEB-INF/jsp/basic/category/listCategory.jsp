...
var gridObj = {};
	$(function(){
  		gridObj = new biz.grid({
            ...
            url: "<m:url value='/category/listCategory.do'/>",/*grid初始化请求数据的远程地址*/
	...
	var show_iframe_dialog;
  	...
  	function add(){
  	//xin zeng iframe 弹出框
		var url="<m:url value='/category/toAddCategory.do'/>";
    ...
    function edit(){
		...
		var url="<m:url value='/category/toEditCategory.do'/>?key="+key;
    ...
    function show(){
		...
		var url="<m:url value='/category/toShowCategory.do'/>?key="+key;
    ...
    */
    ...
    function batchDelete(){
    	var ids = ICSS.utils.getSelectRowData("categoryId");
    	if(ids==""){
    		...
    		new biz.alert({type:"confirm",message:I18N.msg_del_confirm,title:I18N.promp,callback:function(result){
    			if(result){
    				$ .ajax({
        				url: "<m:url value='/category/deleteCategory.do'/>?key="+ids,
        				cache:false,
