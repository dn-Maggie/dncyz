...
$(function() {
	...
	$("#submit").click(function() {
		...
		var options = {
			url : "<m:url value='/platformStore/addPlatformStore.do'/>",
			type : "post",
				dataType:"json",
				success : function(d) {
					if(d.status){
...
<body>
    ...
    <div class="ui-table ui-widget ui-corner-all ui-border" >
		<input type="hidden" id="edit_platformStoreId" name="platformStoreId" type="text" value="${platformStore.platformStoreId}"/>
		<table class="table">
			<tr>
